...
public class Game {
    ...
    public static void main(String args[]) throws OverlapTilesException, OversizeException, AdjacentTilesException, IOException{
        ...
        if (randomPlace()) {
            ...
            Board.drawboards(User.getBoard().getPin(), Comp.getBoard().getPin());
        ...
        do {
            ...
            Comp.getBoard().setPin(User.fire(Comp.getBoard().getPin(), getInput()));
            User.getBoard().setPin(Comp.fire(User.getBoard().getPin(), getRandInput()));
            Board.drawboards(User.getBoard().getPin(), Comp.getBoard().getPin());

            if (Comp.getBoard().allShipsSunk()) {
                System.out.println("You Won !");
                check = false;
            } else if (User.getBoard().allShipsSunk()) {
